...
function elggx_userpoints_init() {
	...
	elgg_extend_view('forms/elggx_userpoints/actions', 'elggx_userpoints/actions/classifieds');
	elgg_extend_view('forms/elggx_userpoints/actions', 'elggx_userpoints/actions/izap_video');
	...
	elgg_extend_view('forms/elggx_userpoints/actions', 'elggx_userpoints/actions/recommendations');
